            ...
            <main>
                ...
                <div className={clsx(styles.mainTextContainer)}>
                    <div className={clsx('row', styles.mainText)}>
                        <p>Our customized Karma Coin app is the perfect tool to strengthen your community, increase core values, and give real-world benefits to your members. With our app, your community will have a unique onboarding experience where we learn what your community's core values and strengths are and then modify the app's rating and appreciation labeling to match your community's language and messaging. This encourages your members to use the app to show and send tokens of appreciation in a way that is familiar to them.</p>
                        <p>Key Benefits:</p>
